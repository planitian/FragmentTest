...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState!=null){
            Zprint.log(BlankFragment.this,"fragment 输出",savedInstanceState.toString());
        }

        View view=inflater.inflate(R.layout.fragment_blank, container, false);
        final TextView textView = view.findViewById(R.id.fragment_text);
        textView.setText(textView.getText().toString()+this.hashCode());
        ...
        Zprint.log(this,"运行",this.hashCode());
        return view;
    }
